...
import com.example.diplomaspringproject.repositories.SystemUserRepository;
...
import static com.example.diplomaspringproject.security.PasswordEncoder.getPasswordEncoder;
...
public class UserService implements UserDetailsService {
    ...
    public SystemUserDtoForDisplay createUser(SystemUserDto request) throws UserException {
        ...
        if (systemUserRepository.findSystemUserByRights(Rights.ROLE_ADMIN).isPresent() &&
